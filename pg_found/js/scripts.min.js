...
jQuery(document).ready(function(){jQuery('input[type="submit"]').addClass("tiny button"),jQuery(".attachment-post-thumbnail").addClass("th"),jQuery('iframe[src*="vimeo.com"]').wrap('<div class="flex-video widescreen vimeo" />'),jQuery('iframe[src*="dailymotion.com"]').wrap('<div class="flex-video widescreen" />'),jQuery('iframe[src*="youtube.com"]').wrap('<div class="flex-video widescreen" />'),jQuery(window).load(function(){jQuery("#topofpage").hide().removeAttr("href"),"0"!=jQuery(window).scrollTop()&&jQuery("#backtotop").fadeIn("slow");var t=jQuery("#backtotop");jQuery(window).scroll(function(){"0"==jQuery(window).scrollTop()?jQuery(t).fadeOut("slow"):jQuery(t).fadeIn("slow")})}),jQuery("#backtotop").click(function(){jQuery("html, body").animate({scrollTop:jQuery("body").offset().top},1e3)})});
